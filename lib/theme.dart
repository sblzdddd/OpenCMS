...
class MaterialTheme {
  ...
  static const success = ExtendedColor(
    seed: Color(0xff39a743),
    value: Color(0xff39a743),
    light: ColorFamily(
  ...
  static const info = ExtendedColor(
    seed: Color(0xff76c4ff),
    value: Color(0xff76c4ff),
    light: ColorFamily(
      color: Color(0xff29638a),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xffcbe6ff),
      onColorContainer: Color(0xff014b71),
    ),
    lightMediumContrast: ColorFamily(
      color: Color(0xff29638a),
      onColor: Color(0xffffffff),
    ...
    dark: ColorFamily(
      color: Color(0xff97ccf9),
      onColor: Color(0xff003450),
      colorContainer: Color(0xff014b71),
      onColorContainer: Color(0xffcbe6ff),
    ),
    darkMediumContrast: ColorFamily(
      color: Color(0xff97ccf9),
      onColor: Color(0xff003450),
