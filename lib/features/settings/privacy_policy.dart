      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            ...
            Text(
              'This application is an independent, community-maintained project and is not affiliated with any public organizations or schools. We do not collect, store, analyze, or transmit any personal data or usage analytics to our servers or to any third parties. Your credentials, if stored, are kept securely and locally on your device. By choosing to use this application, you acknowledge and accept that, because the source code is publicly available, there is an inherent risk of data exposure that cannot be entirely eliminated despite our best efforts to use secure storage mechanisms.',
