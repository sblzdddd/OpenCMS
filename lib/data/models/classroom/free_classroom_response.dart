...
class FreeClassroomResponse {
  ...
  factory FreeClassroomResponse.empty() {
    return FreeClassroomResponse(freeClassrooms: [], date: '', period: '');
  }
  ...
  static List<String> _parseRoomsString(String roomsString) {
    ...
    final List<String> classrooms = roomsString
        .trim()
        .split(' ')
  ...
  Map<String, dynamic> toJson() {
    return {'classrooms': freeClassrooms, 'date': date, 'period': period};
  }
}
