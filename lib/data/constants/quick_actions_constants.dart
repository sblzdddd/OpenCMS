...
class QuickActionsConstants {
  ...
  static const List<Map<String, dynamic>> availableActions = [
    ...
    {'title': 'Course Timetable', 'icon': Symbols.calendar_view_day_rounded, 'id': 'timetable'},
    {'title': 'Exam Timetable', 'icon': Symbols.calendar_clock_rounded, 'id': 'exam'},
    {'title': 'Attendance', 'icon': Symbols.schedule, 'id': 'attendance'},
    {'title': 'Reports', 'icon': Symbols.assignment_rounded, 'id': 'reports'},
    {'title': 'Assessments Feedback', 'icon': Symbols.assessment_rounded, 'id': 'assessment'},
    {'title': 'Teacher Comments', 'icon': Symbols.comment_rounded, 'id': 'comments'},
    ...
    {'title': 'Available Classrooms', 'icon': Symbols.door_open_rounded, 'id': 'available_classrooms'},
    ...
    {'title': 'Courses Details', 'icon': Symbols.school_rounded, 'id': 'courses_details'},
