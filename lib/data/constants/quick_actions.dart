...
class QuickActionsConstants {
  ...
  static const List<Map<String, dynamic>> availableActions = [
    ...
    {'title': 'Bulletin', 'icon': Symbols.format_list_bulleted_rounded, 'id': 'daily_bulletin'},
    {'title': 'Events', 'icon': Symbols.event_upcoming_rounded, 'id': 'events'},
    ...
    {'title': 'Mentoring', 'icon': Symbols.psychiatry_rounded, 'id': 'mentoring'},
    {'title': 'GCA', 'icon': Symbols.diversity_2_rounded, 'id': 'global_citizenship'},
    {'title': 'Surveys', 'icon': Symbols.rate_review_rounded, 'id': 'surveys'},
    {'title': 'Course Selection', 'icon': Symbols.book_rounded, 'id': 'course_selection'},
    {'title': 'Exam Statements', 'icon': Symbols.assignment_turned_in_rounded, 'id': 'exam_entry'},
    {'title': 'Insurance', 'icon': Symbols.health_and_safety_rounded, 'id': 'insurance'},
    {'title': 'E-Agreement', 'icon': Symbols.contract_rounded, 'id': 'e_agreement'},
    {'title': 'Special Concerns', 'icon': Symbols.bookmark_heart_rounded, 'id': 'special_consideration'},
    {'title': 'ID Card', 'icon': Symbols.id_card_rounded, 'id': 'id_card'},
    {'title': 'UniApp', 'icon': Symbols.school_rounded, 'id': 'university_application'},
    {'title': 'Certifications', 'icon': Symbols.license_rounded, 'id': 'certifications'},
