...
class MarkComponentsView extends StatelessWidget {
  ...
  const MarkComponentsView({super.key, required this.markComponents});
  ...
  Widget build(BuildContext context) {
    ...
    for (final entry in groupedBySyllabus.entries) {
      ...
      final totalComponent = components.firstWhere(
        ...
        orElse: () =>
            components.last, // fallback to last if no empty component found
      );
          ...
          return Card(
            ...
            child: Column(
              ...
              children: [
                ...
                ...components
                    .where((component) => component.component.isNotEmpty)
                    .map((component) {
                      return Container(
