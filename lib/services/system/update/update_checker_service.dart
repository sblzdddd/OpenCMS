...
class UpdateCheckerService {
  static const String _githubLatestReleaseApi =
      'https://api.github.com/repos/sblzdddd/OpenCMS/releases/latest';
  static const String _githubReleasesPage =
      'https://github.com/sblzdddd/OpenCMS/releases';
  ...
  static Future<void> checkForUpdates(BuildContext context) async {
    ...
    try {
      ...
      final String currentVersionRaw = packageInfo.version;
    ...
    await showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          content: Text(
            'A new version ($latestVersion) is available. Would you like to view the releases page?',
          ),
          actions: [
            TextButton(
